...
@Slf4j
public class OpenMemoryCard extends Parent {
    ...
    private final OpenMemory gameInstance;
    ...
    private int cardAlreadySelected;
    ...
    public OpenMemoryCard(double positionX, double positionY, double width, double height, Image image, int idc,
            GameContext gameContext, Stats stats, OpenMemory gameInstance, int fixationlength) {
    ...
    private void onCorrectCardSelected() {
        ...
        for (int i = 0; i < gameInstance.currentRoundDetails.cardList.size(); i++) {
            gameInstance.currentRoundDetails.cardList.get(i).cardAlreadySelected = -1;
    ...
    private void onWrongCardSelected() {
        ...
        for (int i = 0; i < gameInstance.currentRoundDetails.cardList.size(); i++) {
            if (gameInstance.currentRoundDetails.cardList.get(i).selected == true) {
                gameInstance.currentRoundDetails.cardList.get(i).selected = false;
                    ...
                    if (cardAlreadySelected == -1) {
                        ...
                        timelineProgressBar.setOnFinished(new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent actionEvent) {
                                ...
                                for (int i = 0; i < gameInstance.currentRoundDetails.cardList.size(); i++) {
                                    gameInstance.currentRoundDetails.cardList.get(i).cardAlreadySelected = id;
                                }
                                progressIndicator.setOpacity(1);
