...
public class Languages {
    ...
    public static final Locale DEFAULT_CODE = Locale.getDefault() != null ? new Locale(Locale.getDefault().getISO3Language(), Locale.getDefault().getCountry()) : CustomLocale.FRANCE;
