...
public class Configuration implements Cloneable {
    ...
    @Getter
    @Setter
    private static Configuration instance = ConfigurationSource.createFromPropertiesResource();
    ...
    private void saveConfig() throws IOException {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(new File(ConfigurationSource.getConfigPath()))) {
    ...
    public void saveConfigIgnoringExceptions() {
        try {
            ...
            log.error("Exception while writing configuration to file {}", ConfigurationSource.getConfigPath(), e);
        }
    }
