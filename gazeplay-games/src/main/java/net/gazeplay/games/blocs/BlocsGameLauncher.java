...
public class BlocsGameLauncher implements IGameLauncher<Stats, DimensionGameVariant> {
    ...
    public Stats createSavedStats(Scene scene,
        ...
        return new BlocsGamesStats(scene, nbGoalsReached, nbGoalsToReach, nbUnCountedGoalsReached,
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext, DimensionGameVariant gameVariant, Stats stats) {
        return new Blocs(gameContext, gameVariant.getWidth(), gameVariant.getHeight(), true, 1, false, stats);
    }

    @Override
    public GameLifeCycle replayGame(IGameContext gameContext, DimensionGameVariant gameVariant, Stats stats, double gameSeed) {
        return new Blocs(gameContext, gameVariant.getWidth(), gameVariant.getHeight(), true, 1, false, stats, gameSeed);
    }
}
