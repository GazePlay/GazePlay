...
public class Target extends Portrait {
    ...
    private void moveRandom(int length) {
        ...
        TranslateTransition translation = new TranslateTransition(
            new Duration(gameContext.getAnimationSpeedRatioSource().getSpeedEffects() * length), this);
    ...
    private void createBackAndForthTranlations(Position pos1, Position pos2, int length) {
        Duration animationLength = new Duration(gameContext.getAnimationSpeedRatioSource().getSpeedEffects() * length);
