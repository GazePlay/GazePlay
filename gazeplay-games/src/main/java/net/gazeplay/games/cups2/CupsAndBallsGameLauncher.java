...
public class CupsAndBallsGameLauncher implements IGameLauncher<Stats, IntGameVariant> {
    @Override
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext, IntGameVariant gameVariant, Stats stats) {
        return new CupsAndBalls(gameContext, stats, gameVariant.getNumber());
    }

    @Override
    public GameLifeCycle replayGame(IGameContext gameContext, IntGameVariant gameVariant, Stats stats, double gameSeed) {
        return new CupsAndBalls(gameContext, stats, gameVariant.getNumber(), gameSeed);
    }
}
