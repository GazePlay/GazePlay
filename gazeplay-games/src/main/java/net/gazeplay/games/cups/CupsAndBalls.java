...
public class CupsAndBalls implements GameLifeCycle {
    ...
    public CupsAndBalls(IGameContext gameContext, Stats stats, int nbCups, int nbExchanges) {
    ...
    private void createNewTransition(ArrayList<Action> actions) {
        ...
        TranslateTransition movementTransition = new TranslateTransition(
                Duration.millis(gameContext.getAnimationSpeedRatioSource().getSpeedEffects() * exchangeCupDuration), cupToMove);
