...
public class FollowEmmanuel implements GameLifeCycle {
    ...
    private void player() {
        ...
        rPlayer.setFill(new ImagePattern(new Image("data/follow2/Biboule.png")));
        gameContext.getChildren().add(rPlayer);
    }

    private void pointer() {
        gaze = new Rectangle(0, 0, dimension2D.getWidth() / 200, dimension2D.getWidth() / 200);
        gaze.setFill(new ImagePattern(new Image("data/follow2/ruby1RS.png")));
    ...
    private void contour() {
        ...
        for (int i = 0; i < x; i++) {
            ...
            w.setFill(new ImagePattern(new Image("data/follow2/wall1.png")));
            listWall.add(w);
    ...
    private void paving() {
        ...
        for (int i = 0; i < x; i++) {
            for (int j = 0; j < y; j++) {
                ...
                d.setFill(new ImagePattern(new Image("data/follow2/slab1.png")));
