...
public class SurviveAgainstRobotsAutomaticLauncher implements IGameLauncher<Stats, EnumGameVariant<SurviveAgainstRobotsVariant>> {
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext, EnumGameVariant<SurviveAgainstRobotsVariant> gameVariant, Stats stats) {
        return new SurviveAgainstRobots(gameContext,gameVariant.getEnumValue(),stats, false, true);
    }
