...
public class MemoryGameLauncherDynamic implements IGameLauncher<Stats, DimensionGameVariant> {
    @Override
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext,
        ...
        return new MemoryDynamic(MemoryDynamic.MemoryGameType.DEFAULT, gameContext, gameVariant.getWidth(),
