...
public class MemoryLettersGameLauncherDynamic implements IGameLauncher<Stats, DimensionGameVariant> {
    @Override
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext,
        ...
        return new MemoryDynamic(MemoryDynamic.MemoryGameType.LETTERS, gameContext, gameVariant.getWidth(),
