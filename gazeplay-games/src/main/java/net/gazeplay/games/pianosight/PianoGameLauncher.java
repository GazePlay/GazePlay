...
public class PianoGameLauncher implements IGameLauncher<ShooterGamesStats, DimensionGameVariant> {
    ...
    @Override
    public ShooterGamesStats createSavedStats(Scene scene, int nbGoalsReached, int nbGoalsToReach, int nbUnCountedGoalsReached, LinkedList<FixationPoint> fixationSequence, LifeCycle lifeCycle, RoundsDurationReport roundsDurationReport, SavedStatsInfo savedStatsInfo) {
