...
public class VideoPlayerGameLauncher implements IGameLauncher<ExplorationGamesStats, StringGameVariant> {
    ...
    @Override
    public ExplorationGamesStats createSavedStats(Scene scene,
    ...
    @Override
    public GameLifeCycle createNewGame(IGameContext gameContext, StringGameVariant gameVariant, ExplorationGamesStats stats) {
        return new VideoPlayerWithLiveFeedbackApp(gameContext, stats, gameVariant.getValue());
    }

    @Override
    public GameLifeCycle replayGame(IGameContext gameContext, StringGameVariant gameVariant, ExplorationGamesStats stats, double gameSeed) {
