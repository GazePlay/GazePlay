...
public class ShootTheBiboulesGameLauncher implements IGameLauncher<Stats,IGameVariant> {
    @Override
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext, IGameVariant gameVariant,
                                       Stats stats) {
        return new ShooterGame(gameContext, stats, "biboule");
    }

    @Override
    public GameLifeCycle replayGame(IGameContext gameContext, IGameVariant gameVariant,
                                       Stats stats, double gameSeed) {
        return new ShooterGame(gameContext, stats, "biboule", gameSeed);
    }
}
