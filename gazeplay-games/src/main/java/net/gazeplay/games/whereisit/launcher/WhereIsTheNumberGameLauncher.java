...
public class WhereIsTheNumberGameLauncher implements IGameLauncher<Stats, DimensionGameVariant> {
    ...
    public Stats createSavedStats(Scene scene,
        ...
        return new WhereIsItStats(scene, WhereIsItGameType.NUMBERS.getGameName(), nbGoalsReached, nbGoalsToReach, nbUnCountedGoalsReached,
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext, DimensionGameVariant gameVariant, Stats stats) {
        return new WhereIsIt(WhereIsItGameType.NUMBERS, gameVariant.getWidth(), gameVariant.getHeight(), false, gameContext, stats);
    }

    @Override
    public GameLifeCycle replayGame(IGameContext gameContext, DimensionGameVariant gameVariant, Stats stats, double gameSeed) {
        return new WhereIsIt(WhereIsItGameType.NUMBERS, gameVariant.getWidth(), gameVariant.getHeight(), false, gameContext, stats, gameSeed);
    }
}
