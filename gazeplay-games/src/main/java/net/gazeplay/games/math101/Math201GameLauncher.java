...
public class Math201GameLauncher implements GameSpec.GameLauncher<Stats, MathGameVariant> {
    @Override
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext, MathGameVariant gameVariant, Stats stats) {
        return new Math101(Math101GameType.MATHALL, gameContext, gameVariant, stats);
    }
}
