...
public class Math101AllOperationsGameSpecSource implements GameSpecSource {
    ...
    public GameSpec getGameSpec() {
        return new GameSpec(
            GameSummary.builder().nameCode("Math101: All operations").gameThumbnail("data/Thumbnails/math101.png").category(GameCategories.Category.LOGIC).description("MathDesc").build(),
