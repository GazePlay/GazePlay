...
public class OpenMemoryLettersGameLauncher implements IGameLauncher<Stats, DimensionDifficultyGameVariant> {
    @Override
    ...
    public GameLifeCycle createNewGame(IGameContext gameContext,
        ...
        return new Memory(Memory.MemoryGameType.LETTERS, gameContext, gameVariant.getWidth(),
            gameVariant.getHeight(), gameVariant.getVariant(), stats, true);
    }
    ...
    public GameLifeCycle replayGame(IGameContext gameContext,
        ...
        return new Memory(Memory.MemoryGameType.LETTERS, gameContext, gameVariant.getWidth(),
            gameVariant.getHeight(), gameVariant.getVariant(), stats, true, gameSeed);
    }
}
