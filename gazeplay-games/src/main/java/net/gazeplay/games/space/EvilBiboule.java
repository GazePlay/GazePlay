...
@Slf4j
public class EvilBiboule extends Rectangle {
    @Getter
    ...
    public EvilBiboule(final double x, final double y, final double width, final double height, final String soundFileLocation, final double windowWidth,
                       final double speed) {
