...
public class Boss extends Rectangle {
    ...
    public Boss(double x, double y, double width, double height, String soundFileLocation, double windowWidth,
            double speed) {
    ...
    public void moveToLeft(double x, double y) {
        TranslateTransition t = new TranslateTransition(Duration.seconds(3), this);
        t.setToX(-x);
        t.setCycleCount(1);
        t.setInterpolator(Interpolator.LINEAR);
    ...
    public void moveToLRight(double x, double y) {
        TranslateTransition t = new TranslateTransition(Duration.seconds(3), this);
        t.setToY(x);
        t.setCycleCount(1);
        t.setInterpolator(Interpolator.LINEAR);
