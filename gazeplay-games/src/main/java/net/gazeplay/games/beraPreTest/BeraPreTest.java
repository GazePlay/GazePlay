...
@Slf4j
public class BeraPreTest implements GameLifeCycle {
    ...
    public void createFileWordComprehension() {
        ...
        String pathFile = "statsBeraPreTestComprehensionMots-" + DateUtils.dateTimeNow() + ".csv";
        ...
        try {
            ...
            log.info("Error creation csv for BeraPreTest stats game !");
            e.printStackTrace();
        }
    }
