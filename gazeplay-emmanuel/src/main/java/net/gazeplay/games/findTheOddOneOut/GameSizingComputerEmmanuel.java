...
public class GameSizingComputerEmmanuel {
    ...
    public GameSizingEmmanuel computeGameSizing(Rectangle2D bounds) {
        ...
        GameSizingEmmanuel gameSizing = new GameSizingEmmanuel(width / nbColumns, height / nbLines, shift);
