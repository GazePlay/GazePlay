...
![Point par point]({{ site.thumbnail_base}}/dottodot.png)
...
![Labyrinthe]({{ site.thumbnail_base }}/labyrinth.png)
...
![Trouvez differences]({{ site.thumbnail_base }}/spotthedifference.png)

## Trouvez l'intrus

Le joueur doit trouver l'intrus parmi les photos qui sont affichées.

![Trouvez intrus]({{ site.thumbnail_base }}/findtheodd.jpg)

## Identifiez La Lettre

Supprimez tous les blocs contenant la lettre mentionnée.

![Identifier lettre]({{ site.thumbnail_base }}/letters.png)
...
![Jeu de oie]({{ site.thumbnail_base }}/goosegame.png)

## Morpion

Aligne 3 croix ou 3 rond avant ton adversaire !

![Morpion]({{ site.thumbnail_base }}/NaC.png)
...
![Échelle]({{ site.thumbnail_base }}/ladder.png)
...
![Bouteille]({{site.thumbnail_base}}/supermarket.jpg)
...
![Ferme]({{site.thumbnail_base}}/farm.png)
...
![Mer]({{site.thumbnail_base}}/ocean.png)
...
![Lecteur vidéo]({{site.thumbnail_base}}/youtube.png)
