...
Mix the right colored potions to prepare Biboule's order. Be careful not to make a bad mix!
...
Make the cake indicated on the recipe book. You should take care of all the layers, icings and decorations to satisfy your customer. <br>
...
Look at the targets in the order they appeared. If the order is correct, a reward will be offered.
...
Draw through your eyes on the canvas. You can change the color by going outside the outline of the canvas.
...
A large picture is hidden by colored blocks that the player must look at to make them disappear. When all the blocks have disappeared, the reward is offered.
...
The player scratches the card with their eyes. When a large portion of the card has been scratched, the image is displayed and the reward offered.
...
Several targets move randomly on the screen. By looking at them, you can split them into two smaller targets. <br>
...
Several rabbits move randomly on the screen. By looking at them, you can split them into two smaller rabbits. <br>
...
Solve math problems: Addition, Subtraction, Multiplication and Division of two numbers.
...
Several cards are displayed and the player must look at them to turn them over. One of these cards has a picture on it. <br>
