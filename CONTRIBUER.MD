...
GazePlay est compilé en java 1.8 produit avec le jdk 1.8 (actuellement, il n'est pas possible d'utiliser une version ulterieure car elle n'intègrent pas JavaFX).
